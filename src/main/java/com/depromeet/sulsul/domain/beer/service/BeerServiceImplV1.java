...
import com.depromeet.sulsul.domain.beer.repository.BeerRepositoryCustomImplV1;
...
@Service
@Transactional
public class BeerServiceImplV1 implements BeerService {

    private final BeerRepository beerRepository;
    private final BeerRepositoryCustom beerRepositoryCustom;
    private final CountryRepository countryRepository;

    public BeerServiceImplV1(BeerRepository beerRepository, BeerRepositoryCustomImplV1 beerRepositoryCustom, CountryRepository countryRepository) {
    ...
    public PageableResponse<BeerDto> findAll(Long memberId, Long beerId) {
        ...
        List<BeerDto> beerDtosWithPageable = beerRepositoryCustom.findByIdWithPageableV1(memberId, beerId);
